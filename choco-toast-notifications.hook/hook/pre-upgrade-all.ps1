...
# choco-toast-notifications.hook v1.2.0 (2026-05-04) Copyleft 2023 by Bill Curran AKA BCURRAN3
...
# Set action for pre-upgrade notification
$chocolateyAction="UPGRADING"
